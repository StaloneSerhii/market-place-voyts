...
const category = [{ label: 'by' }, { label: 'new' }];
        ...
        <div style={{ width: '700px' }}>
          ...
          <div className="block__info" id="app-root">
            <div className="block__info--item">
              ...
              <p className="block__info--on">
                {!formik.values.hidden ? 'В наявності' : 'Прихований'}
              </p>
              <p>
                Приховати товару
                <Switch
              ...
              <input
                ...
                name="counter"
                id="counter"
                placeholder="Кількість до продажу"
                variant="outlined"
                type="number"
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <Link to="" className={'info__btn--details  '}>
              Опис
            </Link>
